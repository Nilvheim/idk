...
if (isset($_POST['id_permohonan']) && isset($_POST['aksi'])) {
    ...
    if ($aksi == "Diterima") {
        ...
        $sql = "SELECT * FROM permohonan_wahyu WHERE nim='$id_permohonan'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (mysqli_query($conn, $sql_insert)) {
                ...
                $sql_delete = "DELETE FROM permohonan_wahyu WHERE nim='$id_permohonan'";
    ...
    <div class="container">
        ...
        <div class="table-container">
            ...
            <table>
                ...
                $sql_permohonan = "SELECT * FROM permohonan_wahyu";
