...
if (isset($_POST['id_permohonan']) && isset($_POST['aksi'])) {
    ...
    if ($aksi == "Diterima") {
        ...
        $sql = "SELECT * FROM permohonan_dwi WHERE nim='$id_permohonan'";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (mysqli_query($conn, $sql_insert)) {
                ...
                $sql_delete = "DELETE FROM permohonan_dwi WHERE nim='$id_permohonan'";
                mysqli_query($conn, $sql_delete);
    
                // Simpan juga data ke tabel pembimbing_ta
                $sql_insert_pembimbing_ta = "INSERT INTO pembimbing_ta (nama, nim, topik_ta) VALUES ('$nama', '$nim', '$topik_ta')";
                if (mysqli_query($conn, $sql_insert_pembimbing_ta)) {
                    // echo "Data berhasil disimpan di tabel pembimbing_ta.";
                } else {
                    echo "Error: " . $sql_insert_pembimbing_ta . "<br>" . mysqli_error($conn);
                }
            } else {
...
// Menampilkan data dari tabel pembimbing_ta berdasarkan nama dosen yang sedang login
// Ganti "mikail" dengan nama dosen yang sesuai
$nama_tabel_dosen = "dwi";

$sql_pembimbing_ta = "SELECT * FROM $nama_tabel_dosen";
$result_pembimbing_ta = mysqli_query($conn, $sql_pembimbing_ta);
    ...
    <div class="container">
        ...
        <div class="table-container">
            ...
            <table>
                ...
                <?php
                // Menampilkan data dari tabel pembimbing_ta
                while ($row = mysqli_fetch_assoc($result_pembimbing_ta)) {
                    echo "<tr>";
                    echo "<td>" . $row['nama'] . "</td>";
                    echo "<td>" . $row['nim'] . "</td>";
